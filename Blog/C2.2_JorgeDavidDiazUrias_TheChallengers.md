...
![imagen](../Imgs/Diagrama%20en%20blanco.png)
...
Se pograma la salida del arduino a 5 volts conectandola hacia una pila de reles porque se necesitan 24 volts para controlar las electrovalvulas

En el video se puedeen observar otros componentes como:
...
- Motores que son controlados para hacer funcionar sus tres ejes
- Ventilador y disipador de calor que evita el sobrecalentamiento
- Estrusor, aqui se introuce el plastico que sera usado para hacer el modelado 3D
- Un pequeño motor que empuja el filamento 
