...
<p align="center">
    <img alt="Logo" src="../Imgs/C1.x_Sensor_FotoresistenciaLDR.png" width=600 height=300>
</p>
...
3. Ensamble el circuito que se muestra utilizado el simulador que halla considerado, colocando la fotorresistencia en la posición LDR y resistencia de acuerdo con la imagen del esquemático:
    ...
    <p align="center"> 
        <img alt="Logo" src="../Imgs/C1.x_CircuitoSensorFotoresistivo.png" width=300 height=400>
    </p>
4. coloque la imagen finalmente obtenida del circuito ensamblado dentro de su simulador.
   
   ![evidencia](../Imgs/A1.2_Circuitoa.png)
![evidencia](../Imgs/A1.2_Circuitob.png)
![evidencia](../Imgs/A1.2_Circuitoc.png)
...
8. **Grafique** a través de los valores registrados en la tabla anterior de tal manera que se pueda observar el comportamiento de la curva del componente LDR e **inserte la grafica**.
    ...
    <p align="center"> 
        <img alt="Logo" src="../Imgs/1.2Grafica.png" width=1098 height=666>
    </p>
...
![evidencia julio](../Imgs/A1.2_Julio_evidencia1.png)
![evidencia jorge](../Imgs/A1.2_Jorge_Evidencia1.png)
![evidenciaAlexis](../Imgs/A1.2_Alexis_Evidencia1.PNG)
